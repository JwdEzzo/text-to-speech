...
import { useLazyGetSpeechQuery } from './api/ttsApi';
import './index.css';
...
function App() {
  ...
  const isLoading = getSpeechResult.isFetching;
  const hasError = Boolean(getSpeechResult.error);
  ...
  return (
    <div className="container">
      ...
      {hasError && <p className="status error">Something went wrong generating the audio.</p>}
